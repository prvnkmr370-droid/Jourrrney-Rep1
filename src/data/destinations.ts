...
export const DESTINATIONS: Destination[] = [
...

  {
    ...
    name: "Nagaur",
    state: "Rajasthan",
    tagline: "The Desert Fort of Ahhichatragarh",
    description: "Nagaur's Ahhichatragarh ('Fort of the Hooded Cobra') is a genuinely underrated Rajasthan fort — a sprawling 12th-century complex with palaces, gardens, and a sophisticated water-channel system, meticulously restored over two decades by the Mehrangarh Museum Trust and now considered one of the best conservation projects in the state. The city is also home to the Nagaur Cattle Fair, one of Rajasthan's largest livestock fairs, drawing traders and their camels, cattle, and horses from across the region every winter.",
    ...
    bestSeason: "October – March (Nagaur Cattle Fair is in January/February)",
    duration: "1–2 days",
    highlights: [{ name: "Ahhichatragarh Fort" }, { name: "Hawa Mahal & Queen's Mahal, inside the fort" }, { name: "18th-century Rajput ceiling paintings" }, { name: "Nagaur Cattle Fair (Jan/Feb)" }, { name: "Fort water-garden system" }],
    transport: [
      { mode: "Train", icon: "🚂", fromDelhi: "Via Jodhpur or Merta Road — long haul", fromMumbai: "Via Jodhpur — ~16–17h", fromBangalore: "Via Jodhpur — 26h+", duration: "~2h road from Jodhpur", costRange: "₹350–₹1,800 (train to Jodhpur) + ₹500–₹1,000 (local transfer)", tips: "Nagaur has its own railway station, but Jodhpur has far better long-distance connections." },
      { mode: "Road", icon: "🚗", fromDelhi: "Via Jaipur/Jodhpur — 8–9h", fromMumbai: "Via Jodhpur — 15–16h", fromBangalore: "—", duration: "~2h from Jodhpur (135 km); ~3.5h from Jaipur", costRange: "₹2,500–₹4,500 cab from Jodhpur", tips: "Sits roughly midway between Jodhpur and Bikaner, making it an easy add-on to either route." },
      { mode: "Flight", icon: "✈️", fromDelhi: "Fly to Jodhpur (1h20m) then ~2h road", fromMumbai: "Fly to Jodhpur, then road", fromBangalore: "Fly to Jodhpur, then road", duration: "1h20m flight + ~2h road", costRange: "₹3,000–₹9,000 (flight) + road transfer", tips: "Jodhpur Airport is the practical option." },
    ],
    accommodation: [
      { type: "Budget Hotels", priceRange: "₹700–₹1,800/night", examples: ["Hotel Ashok Vilas", "Hotel Nagaur Palace (budget wing)"], description: "Simple rooms in Nagaur town." },
      { type: "Heritage Fort Stay", priceRange: "₹8,000–₹20,000/night", examples: ["Ranvas Nagaur (inside the fort itself)"], description: "A genuinely rare opportunity — staying inside the restored Ahhichatragarh fort complex in the former royal ladies' quarters." },
    ],
    localTransport: [
      { mode: "Walking", cost: "Free", notes: "The fort complex is explored on foot", available: true },
      { mode: "Auto Rickshaw", cost: "₹40–₹150", notes: "For getting around town", available: true },
      { mode: "Taxi", cost: "₹1,500–₹3,000 round trip", notes: "For day trips to/from Jodhpur or Bikaner", available: true },
    ],
    nearbyPlaces: [
      { name: "Khimsar (desert dunes & fort)", distance: "60 km", type: "Desert", isHidden: true },
      { name: "Jodhpur", distance: "135 km", type: "Heritage", isHidden: false, id: "jodhpur" },
      { name: "Bikaner", distance: "160 km", type: "Heritage", isHidden: false, id: "bikaner" },
    ],
    budgetBreakdown: [
      { tier: "budget", label: "Backpacker", perDayPerPerson: 900, accommodation: 400, food: 250, transport: 150, activities: 100 },
      { tier: "mid", label: "Comfortable", perDayPerPerson: 2800, accommodation: 1500, food: 550, transport: 400, activities: 350 },
      { tier: "luxury", label: "Fort Heritage Premium", perDayPerPerson: 14000, accommodation: 10000, food: 1800, transport: 700, activities: 1500 },
    ],
    defaultItinerary: [
      { day: 1, title: "Ahhichatragarh Fort", morning: "Explore the fort's restored palaces — Hawa Mahal, Sheesh Mahal, and the Queen's Mahal — with genuinely well-preserved 18th-century wall paintings.", afternoon: "Walk the fort's water-channel garden system, a real feat of desert-era engineering.", evening: "Sunset from the fort ramparts over the old city.", stay: "Ranvas Nagaur (in the fort) or a town hotel", meals: "Rajasthani thali (₹200), fort restaurant dinner if staying inside (₹500)", tips: "The fort's restoration (led by the Mehrangarh Museum Trust) is genuinely one of the best-documented conservation projects in Rajasthan — worth asking staff about if you're interested in the process." },
      { day: 2, title: "Old City & Onward", morning: "Explore Nagaur's old city bazaars, known for genuine local leatherwork and metal crafts.", afternoon: "Depart toward Jodhpur or Bikaner.", evening: "—", stay: "Check out", meals: "Local dhaba lunch (₹150)", tips: "If visiting during the January/February Cattle Fair, book accommodation well ahead — it draws real regional crowds." },
    ],
    womenSafety: {
      score: 7,
      level: "Safe",
      highlights: ["A quieter heritage town with a genuinely well-managed, restored fort complex", "Ranvas Nagaur and other fort-area stays have real hospitality infrastructure", "Low-crowd compared to Jodhpur/Jaipur, making navigation straightforward"],
      precautions: ["Dress modestly in the old city and bazaars", "Agree taxi fares clearly for day trips to/from Jodhpur or Bikaner", "Cattle Fair season (Jan/Feb) brings real crowds — plan accordingly"],
      soloTips: ["The fort and old city are easy and safe to explore independently", "Ranvas Nagaur's boutique-hotel setting is genuinely well suited to solo travellers", "Nagaur's small scale makes it simple to orient yourself quickly"],
      emergencyContacts: [{ label: "Women Helpline Rajasthan", number: "181" }, { label: "Kotwali Nagaur Police Station", number: "95304-13601" }, { label: "Police", number: "100" }],
      safeZones: ["Fort complex", "Main old-city bazaars by day"],
      avoidAreas: ["Unlit outer-town roads after dark"],
    },
    rating: 4.6,
    reviews: 3900,
    mustEat: ["Rajasthani thali", "Dal Baati Churma", "Ker Sangri", "Local Nagauri sweets", "Bajre ki Roti"],
    packingTips: ["Sunscreen and a hat (harsh desert sun)", "Modest clothing", "Comfortable shoes for the fort's palace complex", "Layers for cool desert evenings", "Camera for the fort's restored interiors"],
  },
...

  {
    ...
    name: "Ujjain",
    state: "Madhya Pradesh",
    tagline: "One of Hinduism's Seven Sacred Cities",
    description: "Ujjain is one of the Sapta Puri, Hinduism's seven most sacred cities, and home to Mahakaleshwar, one of only twelve Jyotirlingas (the most sacred Shiva shrines) in India — genuinely distinctive for its Bhasma Aarti, a pre-dawn ritual using sacred ash, performed only here among all Jyotirlinga temples. Ujjain is also one of the four cities that host the Kumbh Mela on rotation (the Ujjain edition is called Simhastha), drawing millions of pilgrims to bathe in the Shipra River once every twelve years.",
    ...
    gallery: [
      ...
      "https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Shri_Ram_Ghat_01.jpg/1280px-Shri_Ram_Ghat_01.jpg",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Ram_Ghat%2C_Ujjain_01.jpg/1280px-Ram_Ghat%2C_Ujjain_01.jpg",
      "https://upload.wikimedia.org/wikipedia/commons/8/8c/Bank_of_Shipra_with_Devotees%2C_Ram_Ghat_%2C_Ujjain_on_a_Bright_Sunny_day.jpg",
    ],
    imageCredit: "Photos: Ashverse, Anchal lilhare, Imakanksha, Bernard Gagnon, Suryansharma — Wikimedia Commons, CC0 / CC BY-SA.",
    category: ["Spiritual", "Culture", "Heritage"],
    bestSeason: "October – March (Simhastha Kumbh Mela occurs once every 12 years)",
    duration: "1–2 days",
    highlights: [{ name: "Mahakaleshwar Jyotirlinga & Bhasma Aarti" }, { name: "Ram Ghat on the Shipra River" }, { name: "Kal Bhairav Temple" }, { name: "Vedh Shala (ancient observatory)" }, { name: "Kaliadeh Palace" }],
    transport: [
      { mode: "Train", icon: "🚂", fromDelhi: "Via Ujjain Junction — ~14–16h", fromMumbai: "Via Ujjain Junction — ~12–14h", fromBangalore: "Via Ujjain — 24h+", duration: "~14–16h from Delhi", costRange: "₹350–₹1,800", tips: "Ujjain Junction is well-connected; many pilgrims combine it with Indore, a short hop away." },
      { mode: "Road", icon: "🚗", fromDelhi: "Long haul, not practical to drive", fromMumbai: "Via Indore — 12–13h", fromBangalore: "—", duration: "~1h from Indore (55 km)", costRange: "₹1,500–₹3,000 cab from Indore", tips: "Indore is the practical hub — Ujjain is an easy day trip or short stay from there." },
      { mode: "Flight", icon: "✈️", fromDelhi: "Fly to Indore (Devi Ahilyabai Holkar Airport, 1h40m) then ~1h road", fromMumbai: "Fly to Indore (1h20m), then road", fromBangalore: "Fly to Indore, then road", duration: "Flight + ~1h road", costRange: "₹3,000–₹9,000 (flight) + road transfer", tips: "Indore is the nearest airport with real connectivity." },
    ],
    accommodation: [
      { type: "Budget Dharamshala/Ashram Stays", priceRange: "₹300–₹1,200/night", examples: ["Various dharamshalas near Mahakaleshwar"], description: "Simple, often donation-based pilgrim lodging genuinely tied to the city's religious character." },
      { type: "Mid-Range Hotels", priceRange: "₹1,500–₹4,000/night", examples: ["Hotel Shipra Residency (MP Tourism)", "Hotel Ramakrishna", "Hotel Grand Tower"], description: "Comfortable rooms, several within walking distance of Mahakaleshwar." },
      { type: "Higher-End Stays", priceRange: "₹5,000–₹10,000/night", examples: ["Radisson Ujjain", "Hotel Sanchi Elite"], description: "More polished options for travellers wanting extra comfort." },
    ],
    localTransport: [
      { mode: "Walking", cost: "Free", notes: "Mahakaleshwar and the main ghat area are compact and walkable", available: true },
      { mode: "Auto Rickshaw", cost: "₹40–₹150", notes: "Standard for getting around the wider city", available: true },
      { mode: "Cycle Rickshaw", cost: "₹30–₹80", notes: "Common for short hops in the temple-area lanes", available: true },
    ],
    nearbyPlaces: [
      { name: "Indore", distance: "55 km", type: "Culture", isHidden: true },
      { name: "Mandu (ruined Sultanate fort city)", distance: "100 km", type: "Heritage", isHidden: true },
      { name: "Omkareshwar (another Jyotirlinga)", distance: "140 km", type: "Spiritual", isHidden: true },
    ],
    budgetBreakdown: [
      { tier: "budget", label: "Backpacker", perDayPerPerson: 800, accommodation: 350, food: 250, transport: 100, activities: 100 },
      { tier: "mid", label: "Comfortable", perDayPerPerson: 2500, accommodation: 1400, food: 500, transport: 300, activities: 300 },
      { tier: "luxury", label: "Comfort Premium", perDayPerPerson: 6500, accommodation: 4500, food: 1000, transport: 500, activities: 500 },
    ],
    defaultItinerary: [
      { day: 1, title: "Mahakaleshwar & the Ghats", morning: "Mahakaleshwar Temple — arrive very early if you want to witness the Bhasma Aarti, which requires advance booking and real queuing.", afternoon: "Kal Bhairav Temple, one of the eight Bhairav shrines guarding the city, with a genuinely unusual tradition of offering liquor to the deity.", evening: "Ram Ghat on the Shipra River at sunset, the main bathing ghat and Simhastha Kumbh Mela site.", stay: "Temple-area hotel or dharamshala", meals: "Pure-veg thali (₹120), prasad where offered", tips: "Bhasma Aarti tickets/passes should be arranged the evening before through the temple's official booking counter or website — it's genuinely oversubscribed most days." },
      { day: 2, title: "Wider Ujjain", morning: "Vedh Shala, an 18th-century astronomical observatory built by Maharaja Jai Singh II (one of five he built across India, alongside Jantar Mantar in Delhi/Jaipur).", afternoon: "Kaliadeh Palace, a real riverside Mughal-era pleasure palace.", evening: "Depart or continue to Indore.", stay: "Check out", meals: "Local thali (₹150)", tips: "Ujjain's astronomical significance is real — it was historically used as India's reference meridian for calendar calculations." },
    ],
    womenSafety: {
      score: 7,
      level: "Safe",
      highlights: ["A major pilgrimage city with a constant, heavy flow of pilgrims", "Mahakaleshwar and the main ghat area are well-lit and actively monitored", "Established hotel and dharamshala infrastructure geared toward visitors of all kinds"],
      precautions: ["Dress conservatively — this is an active, deeply religious pilgrimage city", "Keep valuables secure in the genuinely dense temple crowds, especially during Aarti times", "Be firm but polite with unsolicited puja-service offers near the temple"],
      soloTips: ["The heavy pilgrim traffic makes Mahakaleshwar genuinely easy and safe to visit solo", "Dharamshala stays can be a genuinely social, low-cost option for solo travellers", "Stick to well-lit main temple and ghat areas after dark"],
      emergencyContacts: [{ label: "Ujjain Kotwali Police Station", number: "0734-2551173" }, { label: "Ujjain District Police Control Room", number: "89628-10225" }, { label: "Police", number: "100" }],
      safeZones: ["Mahakaleshwar Temple complex", "Ram Ghat area", "Main pilgrim bazaar"],
      avoidAreas: ["Unlit ghat stretches away from Ram Ghat after dark", "Riverbank areas outside the main ghats at night"],
    },
    rating: 4.7,
    reviews: 16800,
    mustEat: ["Pure-veg thali", "Poha Jalebi (a genuine Malwa-region breakfast staple)", "Dal Bafla", "Bhutte ka Kees (corn curry)", "Prasad sweets from temple-area shops"],
    packingTips: ["Modest, conservative clothing (an active pilgrimage city)", "A change of clothes if planning a ritual dip in the Shipra", "Sandals that can get wet", "Cash — many temple-area vendors and priests don't take cards", "Patience — Bhasma Aarti and main-temple queues genuinely take time"],
  },
