...
// Diu entries below all share the same single island-wide police
// station and hospital — Diu is small and compact enough that there is
// genuinely only one of each for the whole island, both with real,
// directly-confirmed contact details (unlike Daman's hospitals, Diu's
// hospital number is actually published and working).
SAFETY_OVERRIDES["diu"] = {
  police: {
    summary: "Diu Police Station: 02875-252133",
    details: [
      "Diu Police Station — 1st floor, Fort Road, near Collector office, Diu: 02875-252133.",
      "Diu Police Control Room: 02875-254441.",
      "Women Helpline: 1091 · Police: 100 · National Emergency: 112",
    ],
    sourceNote: "Confirmed directly on the official DNH & DD Police Department portal (police.ddd.gov.in/division/diu-police-station/) — first-hand fetch, not search-indexed.",
  },
  medical: {
    summary: "Government Hospital Diu: 02875-252480",
    details: [
      "Government Hospital Diu — PX8H+579, Diu 362520: 02875-252480.",
      "Ambulance: 108",
    ],
    sourceNote: "Confirmed directly on the official DNH & DD Tourism Department's own Hospitals facility listing for Diu (dnhddtourism.in/diu/facilities/hospitals) — unlike Daman's listing, this one has a real, published working phone number.",
  },
};

SAFETY_OVERRIDES["diu-fort"] = {
...
SAFETY_OVERRIDES["nagoa-beach"] = {
  police: { summary: "Diu Police Station: 02875-252133 (~8 km away)", details: ["Diu Police Station — 1st floor, Fort Road, near Collector office, Diu: 02875-252133.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official DNH & DD Police Department portal — Diu's single island-wide station." },
  medical: { summary: "Government Hospital Diu: 02875-252480 (~8 km)", details: ["Government Hospital Diu — PX8H+579, Diu 362520: 02875-252480.", "Ambulance: 108"], sourceNote: "Confirmed directly on the official DNH & DD Tourism Department's Hospitals listing for Diu." },
};

SAFETY_OVERRIDES["ghoghla-beach"] = {
  police: { summary: "Diu Police Station: 02875-252133 (~15 km away)", details: ["Diu Police Station — 1st floor, Fort Road, near Collector office, Diu: 02875-252133.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official DNH & DD Police Department portal — Diu's single island-wide station." },
  medical: { summary: "Government Hospital Diu: 02875-252480 (~15 km)", details: ["Government Hospital Diu — PX8H+579, Diu 362520: 02875-252480.", "Ambulance: 108"], sourceNote: "Confirmed directly on the official DNH & DD Tourism Department's Hospitals listing for Diu." },
};

SAFETY_OVERRIDES["chakratirth-beach"] = {
  police: { summary: "Diu Police Station: 02875-252133 (~2 km away)", details: ["Diu Police Station — 1st floor, Fort Road, near Collector office, Diu: 02875-252133.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official DNH & DD Police Department portal." },
  medical: { summary: "Government Hospital Diu: 02875-252480 (~2 km)", details: ["Government Hospital Diu — PX8H+579, Diu 362520: 02875-252480.", "Ambulance: 108"], sourceNote: "Confirmed directly on the official DNH & DD Tourism Department's Hospitals listing for Diu." },
};

SAFETY_OVERRIDES["ins-khukri-memorial"] = {
  police: { summary: "Diu Police Station: 02875-252133 (~2 km away)", details: ["Diu Police Station — 1st floor, Fort Road, near Collector office, Diu: 02875-252133.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official DNH & DD Police Department portal." },
  medical: { summary: "Government Hospital Diu: 02875-252480 (~2 km)", details: ["Government Hospital Diu — PX8H+579, Diu 362520: 02875-252480.", "Ambulance: 108"], sourceNote: "Confirmed directly on the official DNH & DD Tourism Department's Hospitals listing for Diu." },
};

SAFETY_OVERRIDES["st-paul-church-diu"] = {
  police: { summary: "Diu Police Station: 02875-252133 (within Diu town)", details: ["Diu Police Station — 1st floor, Fort Road, near Collector office, Diu: 02875-252133.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official DNH & DD Police Department portal." },
  medical: { summary: "Government Hospital Diu: 02875-252480", details: ["Government Hospital Diu — PX8H+579, Diu 362520: 02875-252480.", "Ambulance: 108"], sourceNote: "Confirmed directly on the official DNH & DD Tourism Department's Hospitals listing for Diu." },
};

SAFETY_OVERRIDES["zampa-gateway"] = {
  police: { summary: "Diu Police Station: 02875-252133 (within Diu town)", details: ["Diu Police Station — 1st floor, Fort Road, near Collector office, Diu: 02875-252133.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official DNH & DD Police Department portal." },
  medical: { summary: "Government Hospital Diu: 02875-252480", details: ["Government Hospital Diu — PX8H+579, Diu 362520: 02875-252480.", "Ambulance: 108"], sourceNote: "Confirmed directly on the official DNH & DD Tourism Department's Hospitals listing for Diu." },
};

SAFETY_OVERRIDES["naida-caves"] = {
  police: { summary: "Diu Police Station: 02875-252133 (within Diu town)", details: ["Diu Police Station — 1st floor, Fort Road, near Collector office, Diu: 02875-252133.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official DNH & DD Police Department portal." },
  medical: { summary: "Government Hospital Diu: 02875-252480", details: ["Government Hospital Diu — PX8H+579, Diu 362520: 02875-252480.", "Ambulance: 108"], sourceNote: "Confirmed directly on the official DNH & DD Tourism Department's Hospitals listing for Diu." },
};

SAFETY_OVERRIDES["gangeshwar-temple"] = {
  police: { summary: "Diu Police Station: 02875-252133 (~3 km away)", details: ["Diu Police Station — 1st floor, Fort Road, near Collector office, Diu: 02875-252133.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official DNH & DD Police Department portal." },
  medical: { summary: "Government Hospital Diu: 02875-252480 (~3 km)", details: ["Government Hospital Diu — PX8H+579, Diu 362520: 02875-252480.", "Ambulance: 108"], sourceNote: "Confirmed directly on the official DNH & DD Tourism Department's Hospitals listing for Diu." },
};

SAFETY_OVERRIDES["st-thomas-church-museum"] = {
  police: { summary: "Diu Police Station: 02875-252133 (within Diu town)", details: ["Diu Police Station — 1st floor, Fort Road, near Collector office, Diu: 02875-252133.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official DNH & DD Police Department portal." },
  medical: { summary: "Government Hospital Diu: 02875-252480", details: ["Government Hospital Diu — PX8H+579, Diu 362520: 02875-252480.", "Ambulance: 108"], sourceNote: "Confirmed directly on the official DNH & DD Tourism Department's Hospitals listing for Diu." },
};
...
// Goa water bodies (Falls & Lakes) — police stations reuse the same
// directly-confirmed Goa Police citizen portal entries built up across
// earlier stages (Sanguem, Bicholim, Vasco, Old Goa). Hospitals are
// the relevant district hospital / GMC Bambolim depending on location.
SAFETY_OVERRIDES["dudhsagar-waterfalls"] = {
  police: { summary: "Sanguem Police Station: 0832-2604233", details: ["Sanguem Police Station — Sanguem: 0832-2604233.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["aravalem-falls"] = {
  police: { summary: "Bicholim Police Station: 0832-2362233", details: ["Bicholim Police Station — Bicholim: 0832-2362233.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "North Goa District Hospital (Asilo), Mapusa", details: ["North Goa District Hospital (Asilo Hospital) — Mapusa: 0832-2262372.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["kesarval-falls"] = {
  police: { summary: "Vasco Police Station: 0832-2512304", details: ["Vasco Police Station — Vasco da Gama: 0832-2512304.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["mayem-lake"] = {
  police: { summary: "Bicholim Police Station: 0832-2362233", details: ["Bicholim Police Station — Bicholim: 0832-2362233.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "North Goa District Hospital (Asilo), Mapusa", details: ["North Goa District Hospital (Asilo Hospital) — Mapusa: 0832-2262372.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["carambolim-lake"] = {
  police: { summary: "Old Goa Police Station: 0832-2285301", details: ["Old Goa Police Station — Old Goa: 0832-2285301.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "Goa Medical College & Hospital, Bambolim", details: ["Goa Medical College & Hospital — Bambolim: 0832-2458700 / 0832-2458715.", "Ambulance: 108"], sourceNote: "Confirmed via web search referencing the college's own official contact page." },
};
SAFETY_OVERRIDES["netravali-lake"] = {
  police: { summary: "Sanguem Police Station: 0832-2604233", details: ["Sanguem Police Station — Sanguem: 0832-2604233.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["ancestral-goa"] = {
  police: { summary: "Margao Town Police Station: 0832-2705095", details: ["Margao Town Police Station — Margao: 0832-2705095.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["archaeological-museum-of-goa"] = {
  police: { summary: "Old Goa Police Station: 0832-2285301", details: ["Old Goa Police Station — Old Goa: 0832-2285301.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "Goa Medical College & Hospital, Bambolim", details: ["Goa Medical College & Hospital — Bambolim: 0832-2458700 / 0832-2458715.", "Ambulance: 108"], sourceNote: "Confirmed via web search referencing the college's own official contact page." },
};
SAFETY_OVERRIDES["museum-of-christian-art"] = {
  police: { summary: "Old Goa Police Station: 0832-2285301", details: ["Old Goa Police Station — Old Goa: 0832-2285301.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "Goa Medical College & Hospital, Bambolim", details: ["Goa Medical College & Hospital — Bambolim: 0832-2458700 / 0832-2458715.", "Ambulance: 108"], sourceNote: "Confirmed via web search referencing the college's own official contact page." },
};
SAFETY_OVERRIDES["naval-aviation-museum"] = {
  police: { summary: "Vasco Police Station: 0832-2512304", details: ["Vasco Police Station — Vasco da Gama: 0832-2512304.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["museum-of-goa"] = {
  police: { summary: "Calangute Police Station: 0832-2278284", details: ["Calangute Police Station — Calangute: 0832-2278284.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "North Goa District Hospital (Asilo), Mapusa", details: ["North Goa District Hospital (Asilo Hospital) — Mapusa: 0832-2262372.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["dharohar-national-museum-of-customs-gst"] = {
  police: { summary: "Panaji Police Station: 0832-2428482", details: ["Panaji Police Station — Panaji: 0832-2428482, Ext-311.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "Goa Medical College & Hospital, Bambolim", details: ["Goa Medical College & Hospital — Bambolim: 0832-2458700 / 0832-2458715.", "Ambulance: 108"], sourceNote: "Confirmed via web search referencing the college's own official contact page." },
};
SAFETY_OVERRIDES["jama-masjid-sanguem"] = {
  police: { summary: "Sanguem Police Station: 0832-2604233", details: ["Sanguem Police Station — Sanguem: 0832-2604233.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["safa-masjid"] = {
  police: { summary: "Ponda Police Station: 0832-2313101", details: ["Ponda Police Station — Ponda: 0832-2313101.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "Goa Medical College & Hospital, Bambolim", details: ["Goa Medical College & Hospital — Bambolim: 0832-2458700 / 0832-2458715.", "Ambulance: 108"], sourceNote: "Confirmed via web search referencing the college's own official contact page." },
};
SAFETY_OVERRIDES["dr-salim-ali-bird-sanctuary"] = {
  police: { summary: "Panaji Police Station: 0832-2428482", details: ["Panaji Police Station — Panaji: 0832-2428482, Ext-311.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "Goa Medical College & Hospital, Bambolim", details: ["Goa Medical College & Hospital — Bambolim: 0832-2458700 / 0832-2458715.", "Ambulance: 108"], sourceNote: "Confirmed via web search referencing the college's own official contact page." },
};
SAFETY_OVERRIDES["bhagwan-mahavir-wildlife-sanctuary"] = {
  police: { summary: "Sanguem Police Station: 0832-2604233", details: ["Sanguem Police Station — Sanguem: 0832-2604233.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["bondla-wildlife-sanctuary"] = {
  police: { summary: "Ponda Police Station: 0832-2313101", details: ["Ponda Police Station — Ponda: 0832-2313101.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "Goa Medical College & Hospital, Bambolim", details: ["Goa Medical College & Hospital — Bambolim: 0832-2458700 / 0832-2458715.", "Ambulance: 108"], sourceNote: "Confirmed via web search referencing the college's own official contact page." },
};
SAFETY_OVERRIDES["cotigao-wildlife-sanctuary"] = {
  police: { summary: "Canacona Police Station: 0832-2633357", details: ["Canacona Police Station — Canacona: 0832-2633357.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["mhadei-wildlife-sanctuary"] = {
  police: { summary: "Valpoi Police Station: 0832-2374255", details: ["Valpoi Police Station — Valpoi: 0832-2374255.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "North Goa District Hospital (Asilo), Mapusa", details: ["North Goa District Hospital (Asilo Hospital) — Mapusa: 0832-2262372.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["chapora-fort"] = {
  police: { summary: "Anjuna Police Station: 0832-2273233", details: ["Anjuna Police Station — Anjuna: 0832-2273233.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "North Goa District Hospital (Asilo), Mapusa", details: ["North Goa District Hospital (Asilo Hospital) — Mapusa: 0832-2262372.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["cabo-de-rama-fort"] = {
  police: { summary: "Canacona Police Station: 0832-2633357", details: ["Canacona Police Station — Canacona: 0832-2633357.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["reis-magos-fort"] = {
  police: { summary: "Panaji Police Station: 0832-2428482", details: ["Panaji Police Station — Panaji: 0832-2428482, Ext-311.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "Goa Medical College & Hospital, Bambolim", details: ["Goa Medical College & Hospital — Bambolim: 0832-2458700 / 0832-2458715.", "Ambulance: 108"], sourceNote: "Confirmed via web search referencing the college's own official contact page." },
};
SAFETY_OVERRIDES["corjuem-fort"] = {
  police: { summary: "Bicholim Police Station: 0832-2362233", details: ["Bicholim Police Station — Bicholim: 0832-2362233.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "North Goa District Hospital (Asilo), Mapusa", details: ["North Goa District Hospital (Asilo Hospital) — Mapusa: 0832-2262372.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["rachol-fort"] = {
  police: { summary: "Margao Town Police Station: 0832-2705095", details: ["Margao Town Police Station — Margao: 0832-2705095.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["mormugao-fort"] = {
  police: { summary: "Vasco Police Station: 0832-2512304", details: ["Vasco Police Station — Vasco da Gama: 0832-2512304.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["fort-tiracol"] = {
  police: { summary: "Pernem Police Station: 0832-2201233", details: ["Pernem Police Station — Pernem: 0832-2201233.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "North Goa District Hospital (Asilo), Mapusa", details: ["North Goa District Hospital (Asilo Hospital) — Mapusa: 0832-2262372.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["betul-fort"] = {
  police: { summary: "Cuncolim Police Station: 0832-2763234", details: ["Cuncolim Police Station — Cuncolim: 0832-2763234.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "South Goa District Hospital (Hospicio), Margao", details: ["South Goa District Hospital (Hospicio Hospital) — Margao: 0832-2703801.", "Ambulance: 108"], sourceNote: "Sourced via web search referencing the official Directorate of Health Services Goa site." },
};
SAFETY_OVERRIDES["cabo-raj-niwas"] = {
  police: { summary: "Panaji Police Station: 0832-2428482", details: ["Panaji Police Station — Panaji: 0832-2428482, Ext-311.", "Women Helpline: 1091 · Police: 100 · National Emergency: 112"], sourceNote: "Confirmed directly on the official Goa Police citizen portal." },
  medical: { summary: "Goa Medical College & Hospital, Bambolim", details: ["Goa Medical College & Hospital — Bambolim: 0832-2458700 / 0832-2458715.", "Ambulance: 108"], sourceNote: "Confirmed via web search referencing the college's own official contact page." },
};
SAFETY_OVERRIDES["gujarat"] = {
  police: { summary: "Gujarat Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Statewide emergency police: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111 (also 079-23977219 / 079-23977229) — for tourist assistance and information.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Gujarat Tourism helpline numbers confirmed via web search referencing official Gujarat Tourism Department contact listings." },
  medical: { summary: "Civil Hospital Ahmedabad (state's largest) — dial 108 for ambulance statewide", details: ["Civil Hospital Ahmedabad, Asarwa — one of Asia's largest public hospitals, the major referral centre for the state.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service, available statewide.", "Ambulance: 108"], sourceNote: "108 ambulance service and Civil Hospital Ahmedabad's role are well-documented via general web search; specific ward/department numbers not independently verified — call 108 for any medical emergency statewide." },
};
SAFETY_OVERRIDES["ahmedabad"] = {
  police: { summary: "Ahmedabad City Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Ahmedabad City Police control room: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Gujarat Tourism helpline confirmed via web search referencing official Gujarat Tourism Department contact listings; Ahmedabad Police uses the statewide 100 emergency number." },
  medical: { summary: "Civil Hospital Ahmedabad, Asarwa — dial 108 for ambulance", details: ["Civil Hospital Ahmedabad, Asarwa — one of the largest public hospitals in the state, the major referral centre for the city.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and Civil Hospital Ahmedabad's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["vadodara"] = {
  police: { summary: "Vadodara City Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Vadodara City Police control room: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Gujarat Tourism helpline confirmed via web search referencing official Gujarat Tourism Department contact listings; Vadodara Police uses the statewide 100 emergency number." },
  medical: { summary: "SSG Hospital, Vadodara — dial 108 for ambulance", details: ["Sir Sayajirao General (SSG) Hospital — the city's major public referral hospital, attached to Baroda Medical College.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and SSG Hospital's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["kutch"] = {
  police: { summary: "Bhuj City Police Station: 02832-253050 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Bhuj City Police Station: 02832-253050.", "Statewide emergency police: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Bhuj City Police Station number sourced via general web search (aggregator listings), not confirmed directly on an official Gujarat Police citizen portal — call 100 for emergencies to be safe. Gujarat Tourism helpline confirmed via official contact listings." },
  medical: { summary: "G.K. General Hospital, Bhuj — dial 108 for ambulance", details: ["G.K. General Hospital, Bhuj — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service, especially important given how remote parts of the Rann can be.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; G.K. General Hospital identified as Kutch district's main public hospital via search, not independently phone-verified — call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["rajkot"] = {
  police: { summary: "Rajkot City Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Rajkot City Police control room: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Gujarat Tourism helpline confirmed via web search referencing official Gujarat Tourism Department contact listings; Rajkot Police uses the statewide 100 emergency number." },
  medical: { summary: "PDU Civil Hospital, Rajkot — dial 108 for ambulance", details: ["P.D.U. Government Medical College & Civil Hospital, Rajkot — the city's major public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and Civil Hospital Rajkot's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["junagadh"] = {
  police: { summary: "Junagadh City Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Junagadh City Police control room: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Gujarat Tourism helpline confirmed via web search referencing official Gujarat Tourism Department contact listings; Junagadh Police uses the statewide 100 emergency number." },
  medical: { summary: "Junagadh Civil Hospital — dial 108 for ambulance", details: ["Junagadh Civil Hospital — the district's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service — especially relevant given the Girnar trek's remote upper stretches.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; Junagadh Civil Hospital identified as the district's main public hospital via search, not independently phone-verified — call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["jamnagar"] = {
  police: { summary: "Jamnagar City Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Jamnagar City Police control room: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Gujarat Tourism helpline confirmed via web search referencing official Gujarat Tourism Department contact listings; Jamnagar Police uses the statewide 100 emergency number." },
  medical: { summary: "Guru Gobindsingh Government Hospital, Jamnagar — dial 108 for ambulance", details: ["Guru Gobindsingh Government Hospital, Jamnagar — the city's main public referral hospital, attached to M.P. Shah Medical College.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; the hospital's role identified via search, not independently phone-verified — call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["surat"] = {
  police: { summary: "Surat City Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Surat City Police control room: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Gujarat Tourism helpline confirmed via web search referencing official Gujarat Tourism Department contact listings; Surat Police uses the statewide 100 emergency number." },
...
SAFETY_OVERRIDES["bhavnagar"] = {
  police: { summary: "Bhavnagar City Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Bhavnagar City Police control room: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Gujarat Tourism helpline confirmed via web search referencing official Gujarat Tourism Department contact listings; Bhavnagar Police uses the statewide 100 emergency number." },
  medical: { summary: "Sir Takhtsinhji General Hospital, Bhavnagar — dial 108 for ambulance", details: ["Sir Takhtsinhji General Hospital, Bhavnagar — the city's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; the hospital's role identified via search, not independently phone-verified — call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["gandhinagar"] = {
  police: { summary: "Gandhinagar City Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Gandhinagar City Police control room: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Gujarat Tourism helpline confirmed via web search referencing official Gujarat Tourism Department contact listings; Gandhinagar Police uses the statewide 100 emergency number." },
  medical: { summary: "Civil Hospital, Gandhinagar — dial 108 for ambulance", details: ["Civil Hospital, Gandhinagar (Sector 12) — the city's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; the hospital's role identified via search, not independently phone-verified — call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["shivrajpur-beach"] = {
  police: { summary: "Dwarka Police Station: 02892-234523", details: ["Dwarka Police Station: 02892-234523.", "Devbhoomi Dwarka District Control Room: 02833-232002.", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Sourced via web search referencing the official Devbhoomi Dwarka district website and government directories." },
  medical: { summary: "Dwarka General Hospital — dial 108 for ambulance", details: ["General Hospital, Dwarka — the town's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; the hospital identified via general knowledge of the town, not independently phone-verified — call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["madhavpur-beach"] = {
  police: { summary: "Porbandar SP Office: 0286-2211222", details: ["Porbandar Superintendent of Police office: 0286-2211222 (district-level; Madhavpur itself has no dedicated police station — this is the nearest confirmed official contact).", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Sourced via web search referencing Porbandar district police contact listings. Madhavpur is a small village — call 100 for the fastest local response." },
  medical: { summary: "Porbandar Government Hospital — dial 108 for ambulance", details: ["Porbandar Government Hospital — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency given Madhavpur's rural setting." },
};
SAFETY_OVERRIDES["tithal-beach"] = {
  police: { summary: "Valsad City Police Station: 02632-244233", details: ["Valsad City Police Station — Jalaram Road, Valsad: 02632-244233.", "Valsad Police Control Room: 02632-242900/253333.", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Sourced via web search referencing the official SP Valsad website and district contact listings." },
  medical: { summary: "Valsad District Hospital — dial 108 for ambulance", details: ["Valsad District Hospital — the district's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["mandvi-beach"] = {
  police: { summary: "Bhuj City Police Station: 02832-253050", details: ["Bhuj City Police Station: 02832-253050 (district-level; Mandvi's local station was not individually verified).", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Bhuj City Police Station number sourced via general web search aggregator listings, not an official portal — call 100 for emergencies to be safe." },
...
SAFETY_OVERRIDES["pingleshwar-beach"] = {
  police: { summary: "Bhuj City Police Station: 02832-253050", details: ["Bhuj City Police Station: 02832-253050 (district-level; this beach is remote with no dedicated local station).", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Bhuj City Police Station number sourced via general web search aggregator listings, not an official portal — call 100 for emergencies to be safe, especially given the beach's remote setting." },
  medical: { summary: "G.K. General Hospital, Bhuj — dial 108 for ambulance", details: ["G.K. General Hospital, Bhuj — the district's main public hospital, ~100 km away.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service — important given the remote location.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["dumas-beach"] = {
  police: { summary: "Surat City Police: 100", details: ["Surat City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Surat Police uses the statewide 100 emergency number; a Dumas-specific local station number was not individually verified." },
  medical: { summary: "New Civil Hospital, Surat — dial 108 for ambulance", details: ["New Civil Hospital, Surat — one of the largest public hospitals in South Gujarat.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and New Civil Hospital Surat's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["suvali-beach"] = {
  police: { summary: "Surat City Police: 100", details: ["Surat City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Surat Police uses the statewide 100 emergency number; a Suvali-specific local station number was not individually verified." },
  medical: { summary: "New Civil Hospital, Surat — dial 108 for ambulance", details: ["New Civil Hospital, Surat — one of the largest public hospitals in South Gujarat.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and New Civil Hospital Surat's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["dandi-beach"] = {
  police: { summary: "Navsari Town Police Station: 02637-247505", details: ["Navsari Town Police Station — Mota Bazar, Navsari: 02637-247505.", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Sourced via web search referencing the official SP Navsari website and district contact listings." },
  medical: { summary: "Navsari Government Hospital — dial 108 for ambulance", details: ["Navsari Government Hospital — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["mahuva-beach"] = {
  police: { summary: "Mahuva Police Station: 02844-223099", details: ["Mahuva Police Station — Savarkundla Road, Bagicha Chowk, Mahuva: 02844-223099.", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Sourced via web search referencing general Gujarat police-station contact listings." },
  medical: { summary: "Mahuva General Hospital — dial 108 for ambulance", details: ["Government hospital in Mahuva town — the local public facility; Sir Takhtsinhji General Hospital in Bhavnagar (~96 km) is the district's major referral hospital for anything serious.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["gir-national-park"] = {
  police: { summary: "Junagadh City Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Junagadh City Police control room: 100 (nearest city; Sasan Gir itself has a small local police outpost).", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Junagadh Police uses the statewide 100 emergency number; a Sasan Gir-specific outpost number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Sasan Gir PHC / Junagadh Civil Hospital — dial 108 for ambulance", details: ["A primary health centre exists at Sasan Gir for minor issues; Junagadh Civil Hospital (~65 km) is the district's main referral hospital for anything serious.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency given Sasan Gir's rural setting." },
};
SAFETY_OVERRIDES["velavadar-blackbuck-national-park"] = {
  police: { summary: "Bhavnagar City Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Bhavnagar City Police control room: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Bhavnagar Police uses the statewide 100 emergency number; call 100 for the fastest response given the park's rural setting." },
  medical: { summary: "Sir Takhtsinhji General Hospital, Bhavnagar — dial 108 for ambulance", details: ["Sir Takhtsinhji General Hospital, Bhavnagar (~42 km) — the region's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["wild-ass-sanctuary"] = {
  police: { summary: "Surendranagar District Police: 100", details: ["Surendranagar District Police control room: 100 (Dasada, the sanctuary's gateway village, has no dedicated station — this is the nearest district-level contact).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A Dasada-specific local station number was not individually verified — call 100 for the fastest response in this rural sanctuary area." },
  medical: { summary: "Dhrangadhra/Surendranagar Government Hospital — dial 108 for ambulance", details: ["Government hospitals in Dhrangadhra or Surendranagar town serve this rural sanctuary area.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service — especially important given the sanctuary's remote salt-flat terrain.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["nalsarovar-bird-sanctuary"] = {
  police: { summary: "Ahmedabad Rural Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Ahmedabad Rural Police control room: 100 (Nalsarovar falls under Ahmedabad district's rural jurisdiction).", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A Nalsarovar-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Civil Hospital Ahmedabad — dial 108 for ambulance", details: ["Civil Hospital Ahmedabad (~65 km) — one of the largest public hospitals in the state, for anything serious.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and Civil Hospital Ahmedabad's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["khijadiya-bird-sanctuary"] = {
  police: { summary: "Jamnagar City Police: 100", details: ["Jamnagar City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Jamnagar Police uses the statewide 100 emergency number; a Khijadiya-specific local station number was not individually verified." },
  medical: { summary: "Guru Gobindsingh Government Hospital, Jamnagar — dial 108 for ambulance", details: ["Guru Gobindsingh Government Hospital, Jamnagar (~10 km).", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["thol-lake-sanctuary"] = {
  police: { summary: "Ahmedabad Rural Police: 100", details: ["Ahmedabad Rural Police control room: 100 (Thol falls under Ahmedabad district's rural/Kadi jurisdiction).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A Thol-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Civil Hospital Ahmedabad — dial 108 for ambulance", details: ["Civil Hospital Ahmedabad (~40 km) — for anything serious.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and Civil Hospital Ahmedabad's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["hingolgadh-nature-education-sanctuary"] = {
  police: { summary: "Rajkot City Police: 100", details: ["Rajkot City Police control room: 100 (nearest city; Jasdan taluka police cover the immediate sanctuary area).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A Jasdan-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "PDU Civil Hospital, Rajkot — dial 108 for ambulance", details: ["P.D.U. Government Medical College & Civil Hospital, Rajkot (~65 km) — the region's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["shoolpaneshwar-wildlife-sanctuary"] = {
  police: { summary: "Narmada District Police (Rajpipla): 100", details: ["Narmada District Police control room: 100 (Rajpipla is the district HQ).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A Rajpipla-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Rajpipla General Hospital — dial 108 for ambulance", details: ["Government hospital in Rajpipla — the district's main public facility.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["ratanmahal-sloth-bear-sanctuary"] = {
  police: { summary: "Dahod District Police: 100", details: ["Dahod District Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A sanctuary-specific local station number was not individually verified — call 100 for the fastest response given the remote setting." },
  medical: { summary: "Dahod District Hospital — dial 108 for ambulance", details: ["Dahod District Hospital — the district's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service — especially important given the sanctuary's remote, forested terrain.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["chhari-dhand-wetland-reserve"] = {
  police: { summary: "Bhuj City Police Station: 02832-253050", details: ["Bhuj City Police Station: 02832-253050 (district-level; the reserve itself has no dedicated local station).", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Bhuj City Police Station number sourced via general web search aggregator listings, not an official portal — call 100 for emergencies to be safe." },
  medical: { summary: "G.K. General Hospital, Bhuj — dial 108 for ambulance", details: ["G.K. General Hospital, Bhuj — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["kutch-great-indian-bustard-sanctuary"] = {
  police: { summary: "Bhuj City Police Station: 02832-253050", details: ["Bhuj City Police Station: 02832-253050 (district-level; Naliya's local police cover the immediate sanctuary area).", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Bhuj City Police Station number sourced via general web search aggregator listings, not an official portal — call 100 for emergencies to be safe, especially given this sanctuary's remote setting." },
  medical: { summary: "G.K. General Hospital, Bhuj — dial 108 for ambulance", details: ["G.K. General Hospital, Bhuj (~90 km) — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service — important given the remote location.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["devalia-safari-park"] = {
  police: { summary: "Junagadh City Police: 100", details: ["Junagadh City Police control room: 100 (nearest city; Sasan Gir shares the same jurisdiction as Gir National Park).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A Sasan Gir-specific outpost number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Sasan Gir PHC / Junagadh Civil Hospital — dial 108 for ambulance", details: ["A primary health centre exists at Sasan Gir; Junagadh Civil Hospital (~65 km) is the district's main referral hospital for anything serious.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["jessore-sloth-bear-sanctuary"] = {
  police: { summary: "Banaskantha District Police: 100", details: ["Banaskantha District Police control room: 100 (Palanpur is the district HQ).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A sanctuary-specific local station number was not individually verified — call 100 for the fastest response given the remote border setting." },
  medical: { summary: "Palanpur Civil Hospital — dial 108 for ambulance", details: ["Palanpur Civil Hospital — the district's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["jambughoda-wildlife-sanctuary"] = {
  police: { summary: "Vadodara City Police: 100", details: ["Vadodara City Police control room: 100 (nearest major city; Panchmahal district covers the immediate sanctuary area).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A sanctuary-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "SSG Hospital, Vadodara — dial 108 for ambulance", details: ["Sir Sayajirao General (SSG) Hospital, Vadodara (~65 km).", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["purna-wildlife-sanctuary"] = {
  police: { summary: "Dang District Police: 100", details: ["Dang District Police control room: 100 (Ahwa is the district HQ; Waghai is the sanctuary's gateway town).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A sanctuary-specific local station number was not individually verified — call 100 for the fastest response given the dense, remote forest setting." },
  medical: { summary: "Waghai/Ahwa Government Hospital — dial 108 for ambulance", details: ["Government hospitals in Waghai or Ahwa serve this forested district.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service — especially important given the sanctuary's dense forest terrain.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["balaram-ambaji-wildlife-sanctuary"] = {
  police: { summary: "Banaskantha District Police: 100", details: ["Banaskantha District Police control room: 100 (Palanpur is the district HQ; Ambaji has its own local police presence given the temple's pilgrim traffic).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A sanctuary-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Palanpur Civil Hospital — dial 108 for ambulance", details: ["Palanpur Civil Hospital — the district's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["kutch-desert-sanctuary"] = {
  police: { summary: "Bhuj City Police Station: 02832-253050", details: ["Bhuj City Police Station: 02832-253050 (district-level; this vast sanctuary spans multiple local jurisdictions).", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Bhuj City Police Station number sourced via general web search aggregator listings, not an official portal — call 100 for emergencies to be safe, especially given the sanctuary's remote and vast interior." },
  medical: { summary: "G.K. General Hospital, Bhuj — dial 108 for ambulance", details: ["G.K. General Hospital, Bhuj — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service — critical given how remote parts of this sanctuary are.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["rani-ki-vav"] = {
...
SAFETY_OVERRIDES["sarkhej-roza"] = {
  police: { summary: "Ahmedabad City Police: 100 · Gujarat Tourism Toll-Free: 1800-203-1111", details: ["Ahmedabad City Police control room: 100.", "Gujarat Tourism Department toll-free helpline: 1800-203-1111.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Ahmedabad Police uses the statewide 100 emergency number; Gujarat Tourism helpline confirmed via official contact listings." },
...
SAFETY_OVERRIDES["modhera-sun-temple"] = {
  ...
  medical: { summary: "Mehsana Civil Hospital — dial 108 for ambulance", details: ["Mehsana Civil Hospital — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["adi-kadi-vav-navghan-kuwo"] = {
  police: { summary: "Junagadh City Police: 100", details: ["Junagadh City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Junagadh Police uses the statewide 100 emergency number; both stepwells sit within the well-managed Uparkot Fort complex." },
  medical: { summary: "Junagadh Civil Hospital — dial 108 for ambulance", details: ["Junagadh Civil Hospital — the district's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["bai-harir-ni-vav"] = {
...
SAFETY_OVERRIDES["lakhpat-fort"] = {
  police: { summary: "Bhuj City Police Station: 02832-253050", details: ["Bhuj City Police Station: 02832-253050 (district-level; Lakhpat is a remote border town with no dedicated tourist-facing station).", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Bhuj City Police Station number sourced via general web search aggregator listings, not an official portal — call 100 for emergencies to be safe, especially given this site's remote border-area setting." },
  medical: { summary: "G.K. General Hospital, Bhuj — dial 108 for ambulance", details: ["G.K. General Hospital, Bhuj (~135 km) — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service — critical given how remote Lakhpat is.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["bhadra-fort"] = {
  police: { summary: "Ahmedabad City Police: 100", details: ["Ahmedabad City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Ahmedabad Police uses the statewide 100 emergency number; a site-specific local station number was not individually verified." },
  medical: { summary: "Civil Hospital Ahmedabad — dial 108 for ambulance", details: ["Civil Hospital Ahmedabad — one of the largest public hospitals in the state.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and Civil Hospital Ahmedabad's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["mahabat-khan-maqbara"] = {
  police: { summary: "Junagadh City Police: 100", details: ["Junagadh City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Junagadh Police uses the statewide 100 emergency number; a site-specific local station number was not individually verified." },
  medical: { summary: "Junagadh Civil Hospital — dial 108 for ambulance", details: ["Junagadh Civil Hospital — the district's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["hutheesing-jain-temple"] = {
  police: { summary: "Ahmedabad City Police: 100", details: ["Ahmedabad City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Ahmedabad Police uses the statewide 100 emergency number; a site-specific local station number was not individually verified." },
  medical: { summary: "Civil Hospital Ahmedabad — dial 108 for ambulance", details: ["Civil Hospital Ahmedabad — one of the largest public hospitals in the state.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and Civil Hospital Ahmedabad's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["siddi-saiyyed-mosque"] = {
  police: { summary: "Ahmedabad City Police: 100", details: ["Ahmedabad City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Ahmedabad Police uses the statewide 100 emergency number; a site-specific local station number was not individually verified." },
  medical: { summary: "Civil Hospital Ahmedabad — dial 108 for ambulance", details: ["Civil Hospital Ahmedabad — one of the largest public hospitals in the state.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and Civil Hospital Ahmedabad's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["jama-masjid-ahmedabad"] = {
  police: { summary: "Ahmedabad City Police: 100", details: ["Ahmedabad City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Ahmedabad Police uses the statewide 100 emergency number; a site-specific local station number was not individually verified." },
  medical: { summary: "Civil Hospital Ahmedabad — dial 108 for ambulance", details: ["Civil Hospital Ahmedabad — one of the largest public hospitals in the state.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and Civil Hospital Ahmedabad's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["idar-fort"] = {
...
SAFETY_OVERRIDES["somnath-temple"] = {
  police: { summary: "Gir Somnath District Police: 100", details: ["Gir Somnath District Police control room: 100 (Veraval is the district HQ).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A temple-specific local station number was not individually verified — call 100 for the fastest response given the site's scale." },
...
SAFETY_OVERRIDES["dwarkadhish-temple"] = {
  police: { summary: "Dwarka Police Station: 02892-234523", details: ["Dwarka Police Station: 02892-234523.", "Devbhoomi Dwarka District Control Room: 02833-232002.", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Sourced via web search referencing the official Devbhoomi Dwarka district website and government directories." },
  medical: { summary: "Dwarka General Hospital — dial 108 for ambulance", details: ["General Hospital, Dwarka — the town's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["nageshwar-jyotirlinga"] = {
  police: { summary: "Dwarka Police Station: 02892-234523", details: ["Dwarka Police Station: 02892-234523.", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Sourced via web search referencing the official Devbhoomi Dwarka district website and government directories." },
  medical: { summary: "Dwarka General Hospital — dial 108 for ambulance", details: ["General Hospital, Dwarka — the town's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["ambaji-temple"] = {
  police: { summary: "Banaskantha District Police: 100", details: ["Banaskantha District Police control room: 100 (Ambaji has its own local police presence given the temple's major pilgrim traffic).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A temple-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Ambaji/Palanpur Civil Hospital — dial 108 for ambulance", details: ["A government dispensary serves Ambaji town; Palanpur Civil Hospital is the district's main referral hospital for anything serious.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["palitana-shatrunjaya-hill"] = {
  police: { summary: "Palitana Police Station: 100", details: ["Palitana Police Station control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A specific direct-dial station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Palitana General Hospital — dial 108 for ambulance", details: ["A government hospital serves Palitana town; Sir Takhtsinhji General Hospital, Bhavnagar (~50 km) for anything serious.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service — important given the physically demanding hill climb.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency, including heat-related issues on the climb." },
};
SAFETY_OVERRIDES["udvada-atash-behram"] = {
  police: { summary: "Valsad City Police Station: 02632-244233", details: ["Valsad City Police Station: 02632-244233 (Udvada itself is a small town with no dedicated station).", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Sourced via web search referencing the official SP Valsad website and district contact listings." },
  medical: { summary: "Valsad District Hospital — dial 108 for ambulance", details: ["Valsad District Hospital — the district's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["ranchhodrai-temple-dakor"] = {
  police: { summary: "Kheda District Police: 100", details: ["Kheda District Police control room: 100 (Nadiad is the district HQ; Dakor has its own local police given the temple's major pilgrim traffic).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A temple-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Dakor/Nadiad Civil Hospital — dial 108 for ambulance", details: ["A government hospital serves Dakor town; Nadiad Civil Hospital is the district's main referral hospital for anything serious.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["pavagadh-kalika-mata-temple"] = {
  ...
  medical: { summary: "Godhra/Halol Civil Hospital — dial 108 for ambulance", details: ["Government hospitals in Halol or Godhra serve this area.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service — important given the hill climb involved.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["rukmini-devi-temple"] = {
  police: { summary: "Dwarka Police Station: 02892-234523", details: ["Dwarka Police Station: 02892-234523.", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Sourced via web search referencing the official Devbhoomi Dwarka district website and government directories." },
  medical: { summary: "Dwarka General Hospital — dial 108 for ambulance", details: ["General Hospital, Dwarka — the town's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["nishkalank-mahadev-temple"] = {
  police: { summary: "Bhavnagar City Police: 100", details: ["Bhavnagar City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Bhavnagar Police uses the statewide 100 emergency number; a Koliyak-specific local station number was not individually verified." },
  medical: { summary: "Sir Takhtsinhji General Hospital, Bhavnagar — dial 108 for ambulance", details: ["Sir Takhtsinhji General Hospital, Bhavnagar (~25 km) — the region's main public referral hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["swaminarayan-mandir-kalupur"] = {
  police: { summary: "Ahmedabad City Police: 100", details: ["Ahmedabad City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "Ahmedabad Police uses the statewide 100 emergency number; a site-specific local station number was not individually verified." },
  medical: { summary: "Civil Hospital Ahmedabad — dial 108 for ambulance", details: ["Civil Hospital Ahmedabad — one of the largest public hospitals in the state.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service and Civil Hospital Ahmedabad's role are well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["shamlaji-temple"] = {
  police: { summary: "Aravalli District Police: 100", details: ["Aravalli District Police control room: 100 (Modasa is the district HQ).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A site-specific local station number was not individually verified — call 100 for the fastest response." },
...
SAFETY_OVERRIDES["taranga-hill-jain-temple"] = {
  police: { summary: "Mehsana District Police: 100", details: ["Mehsana District Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A site-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Mehsana Civil Hospital — dial 108 for ambulance", details: ["Mehsana Civil Hospital — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["bahuchar-mata-temple"] = {
  police: { summary: "Mehsana District Police: 100", details: ["Mehsana District Police control room: 100 (Becharaji has its own local police presence given the temple's major pilgrim traffic).", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A temple-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Mehsana Civil Hospital — dial 108 for ambulance", details: ["Mehsana Civil Hospital — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["sudama-mandir"] = {
  police: { summary: "Porbandar SP Office: 0286-2211222", details: ["Porbandar Superintendent of Police office: 0286-2211222; Kirtimandir Police Station (central Porbandar): 0286-2240944.", "Women Helpline: 181 · Police: 100 · National Emergency: 112"], sourceNote: "Sourced via web search referencing Porbandar district police contact listings." },
  medical: { summary: "Porbandar Government Hospital — dial 108 for ambulance", details: ["Porbandar Government Hospital — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["bhalka-tirth"] = {
...
SAFETY_OVERRIDES["adalaj-trimandir"] = {
  police: { summary: "Gandhinagar City Police: 100", details: ["Gandhinagar City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A site-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Civil Hospital, Gandhinagar — dial 108 for ambulance", details: ["Civil Hospital, Gandhinagar (Sector 12) — the city's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
SAFETY_OVERRIDES["triveni-sangam-somnath"] = {
  police: { summary: "Gir Somnath District Police: 100", details: ["Gir Somnath District Police control room: 100.", "Women Helpline: 181 · National Emergency: 112"], sourceNote: "A site-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Veraval General Hospital — dial 108 for ambulance", details: ["Veraval General Hospital — the district's main public hospital.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};
...
SAFETY_OVERRIDES["sabarmati-ashram"] = {
  police: { summary: "Ahmedabad City Police: 100", details: ["Ahmedabad City Police control room: 100.", "Women Helpline: 181 · National Emergency: 112", "On-site ashram security staff are present throughout opening hours."], sourceNote: "Ahmedabad City Police's general emergency line is well-documented; a dedicated ashram security desk exists on-site but was not independently verified with its own number." },
  medical: { summary: "Civil Hospital, Ahmedabad — dial 108 for ambulance", details: ["Civil Hospital Ahmedabad, one of the city's largest, is near the ashram in Asarwa.", "GVK EMRI 108 is Gujarat's real, well-established free ambulance service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};

SAFETY_OVERRIDES["statue-of-unity"] = {
...
SAFETY_OVERRIDES["menal-waterfall-temples"] = {
  police: { summary: "Chittorgarh District Police: 100", details: ["Chittorgarh District Police control room: 100.", "Police: 100 · National Emergency: 112", "Women Helpline Rajasthan: 181"], sourceNote: "A site-specific local station number was not individually verified — call 100 for the fastest response." },
...
SAFETY_OVERRIDES["ajabgarh-fort"] = {
...
SAFETY_OVERRIDES["abbey-falls"] = {
  police: { summary: "Kodagu District Police: 100", details: ["Kodagu District Police control room: 100.", "Police: 100 · National Emergency: 112", "Karnataka Women Helpline: 181"], sourceNote: "A site-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Madikeri District Hospital — dial 108 for ambulance", details: ["Madikeri District Hospital serves the wider Coorg area.", "Karnataka's 108 ambulance service is a well-documented, free emergency service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};

SAFETY_OVERRIDES["dubare-elephant-camp"] = {
  police: { summary: "Kodagu District Police: 100", details: ["Kodagu District Police control room: 100.", "Forest department staff and mahouts oversee all elephant interactions.", "Police: 100 · National Emergency: 112", "Karnataka Women Helpline: 181"], sourceNote: "A site-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Kushalnagar Government Hospital — dial 108 for ambulance", details: ["Kushalnagar's government hospital is the nearest major facility.", "Karnataka's 108 ambulance service is a well-documented, free emergency service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};

SAFETY_OVERRIDES["talacauvery"] = {
  police: { summary: "Kodagu District Police: 100", details: ["Kodagu District Police control room: 100.", "Police: 100 · National Emergency: 112", "Karnataka Women Helpline: 181"], sourceNote: "A site-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Madikeri District Hospital — dial 108 for ambulance", details: ["Madikeri District Hospital serves the wider Coorg area, including Talacauvery.", "Karnataka's 108 ambulance service is a well-documented, free emergency service, though response to this remote hilltop site may take longer than in town.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency, noting the site's remote hilltop location." },
};
SAFETY_OVERRIDES["yana-caves"] = {
  ...
  medical: { summary: "Kumta General Hospital — dial 108 for ambulance", details: ["Kumta's general hospital is the nearest major facility.", "Karnataka's 108 ambulance service is a well-documented, free emergency service, though response to this remote forest site may take longer than in town.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency, noting the site's remote forest location." },
};

SAFETY_OVERRIDES["mirjan-fort"] = {
  police: { summary: "Uttara Kannada District Police: 100", details: ["Uttara Kannada District Police control room: 100.", "Police: 100 · National Emergency: 112", "Karnataka Women Helpline: 181"], sourceNote: "A site-specific local station number was not individually verified — call 100 for the fastest response." },
  medical: { summary: "Kumta General Hospital — dial 108 for ambulance", details: ["Kumta's general hospital is the nearest major facility.", "Karnataka's 108 ambulance service is a well-documented, free emergency service.", "Ambulance: 108"], sourceNote: "108 ambulance service is well-documented via general web search; call 108 for any medical emergency." },
};

SAFETY_OVERRIDES["iruppu-falls"] = {
  police: { summary: "Kodagu District Police: 100", details: ["Kodagu District Police control room: 100.", "Police: 100 · National Emergency: 112", "Karnataka Women Helpline: 181"], sourceNote: "A site-specific local station number was not individually verified — call 100 for the fastest response." },
